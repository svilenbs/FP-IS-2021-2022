...
-- Write function sum on an Integer list. In case of empty list, result should be 1.
-- Write function multiple on an Integer list
-- Write function avg1 returning the average element (sum/length) of a list
-- Write function zip1 working with list and returning list of 2 elements list
...
-- Write function that generate all possible lists for a^2 + b^2 = c^2 for up to number c
